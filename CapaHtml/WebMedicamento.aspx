<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebMedicamento.aspx.cs" Inherits="CapaHtml.WebMedicamento" %>
...
<body class="form-control bg-light">
    ...
    <div class="container example_container">
        <div class="row">
            <div class="title">
                <h2><i class="fas fa-prescription-bottle"></i> Registro Medicamentos</h2>
            </div>
                <form id="formulario_registro" class="form-check" runat="server">
                        ...
                        <fieldset>
                          <div class="alert alert-success d-flex align-items-center" role="alert">
                            ...
                            <asp:Table runat="server" Width="100%">
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Label runat="server" ID="Label1" Text="Codigo:"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtcodigo" placeholder=""></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox CssClass="form-control" runat="server" ID="txtTipo" placeholder=""></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                    ...
                    <div class="mt-5">
                         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="codigo" DataSourceID="SqlDataSource2" CssClass="table table-dark">
                              <Columns>
                                  <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
                                  <asp:BoundField DataField="codigo" HeaderText="codigo" ReadOnly="True" SortExpression="codigo" />
                                  <asp:BoundField DataField="nombre_medicamento" HeaderText="nombre_medicamento" SortExpression="nombre_medicamento" />
                                  <asp:BoundField DataField="tipo_medicamento" HeaderText="tipo_medicamento" SortExpression="tipo_medicamento" />
                                  <asp:BoundField DataField="fecha_fabricacion" HeaderText="fecha_fabricacion" SortExpression="fecha_fabricacion" />
